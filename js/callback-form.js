...
const userName = document.querySelector('#callbackform-input-name');
const userEmail = document.querySelector('#callbackform-input-email');
const userPhone = document.querySelector('#callbackform-input-phone');
